...
/// Convert a tick position to seconds using the provided tempo map.
/// This is the core timing function for tick-based MIDI playback.
pub fn ticks_to_seconds(ticks: i64, tempos: &[MidiTempo], ppq: u32) -> f64 {
    let mut time = 0.0;
